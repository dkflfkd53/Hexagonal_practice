package com.example.hexagonal_practice.domain.board.account.adapter.in.web;
...
import com.example.hexagonal_practice.domain.board.account.application.port.in.*;
